...
|highlightedVideos|Array[Object] |false |Array of highlighted videos data. May be empty.
|highlightedVideos[].image |String |false |Highlighted video image URL.
|highlightedVideos[].video |Object |false |Highlighted video object.
|highlightedVideos[].video.name |String |false |Name of the Video (e.g. 'RPM #79 Express', 'BODYPUMP #100').
|highlightedVideos[].video.id |String |false |Unique ID of the Video.
|highlightedVideos[].video.duration |Integer |false |Video duration in seconds.
|highlightedVideos[].video.episode |Object |true |Video Episode.
|highlightedVideos[].video.episode.number |Integer |true |Number of episode in season.
|highlightedVideos[].video.episode.season |Integer |true |Number of season.
|highlightedVideos[].video.thumbnail |String |false |Thumbnail of the Video.
|highlightedVideos[].video.customInfo |Map |false |Array of Key-Value to represent additional information of an entity. Partners could contain diverse information of same entities. This type designed to store that information.
|highlightedVideos[].video.attachments |Array[Object] |true |Video attachments.
|highlightedVideos[].video.attachments[].title |string |false |Title of the attachment.
|highlightedVideos[].video.attachments[].url |string |false |URL of the attachment.
|highlightedVideos[].video.premium |Boolean |false |Indicates whether the video belongs to the premium category.
|highlightedVideos[].video.instructor |String |true |Instructor name.
|highlightedVideos[].video.instructorId |String |true |Instructor ID.
|highlightedVideos[].video.instructors[] |Array[Object] |false |Instructor objects.
|highlightedVideos[].video.instructors[].name |String |true |Instructor name.
|highlightedVideos[].video.instructors[].id |String |true |Instructor ID.
|highlightedVideos[].video.level |String |true |Workout level.
|highlightedVideos[].video.location |String |true |Location metadata of the video (e.g. 'Wichita', 'Houston').
|highlightedVideos[].video.category |Integer |false |Video Category ID (deprecated).
|highlightedVideos[].video.program |Integer |false |Video Category ID.
|highlightedVideos[].video.programName |String |false |Video Category name.
|highlightedVideos[].video.releaseDate |Integer |false |Video release timestamp.
|highlightedVideos[].video.workoutModality |String |false |Workout modality.
|highlightedVideos[].video.hardwareManufacturer |String |true |Hardware manufacturer.
|highlightedVideos[].video.language |String |false |Video language.
|highlightedVideos[].topLevelCategory |Object |false |Top level category related to highlighted videos.
|highlightedVideos[].topLevelCategory.name |String |false |Name of the Sub-category (e.g. 'Judo', 'Taekwondo').
|highlightedVideos[].topLevelCategory.hidden |Boolean |false |Indicates whether the Category is hidden or not.
|highlightedVideos[].topLevelCategory.parent_program_id |String or null |false |Unique ID of the parent Category or null.
|highlightedVideos[].topLevelCategory.id |String |false |Unique ID of the Sub-category.
|highlightedVideos[].topLevelCategory.videoCount |Integer |false |An estimated number of videos in category (might not be precise).
|highlightedVideos[].topLevelCategory.thumbnail |String |false |Thumbnail of the Sub-category (scaled and cropped to 1280x700).
|highlightedVideos[].topLevelCategory.thumbnails |Object |false |Thumbnails of the Category.
|highlightedVideos[].topLevelCategory.thumbnails.original |String |false |URL to the category image source or empty string.
|highlightedVideos[].topLevelCategory.thumbnails.1920x1080 |String |false |URL to the category image scaled and cropped to 1080p 16:9 or empty string.
|highlightedVideos[].topLevelCategory.thumbnails.1280x720 |String |false |URL to the category image scaled and cropped to 720p 16:9 or empty string.
|highlightedVideos[].topLevelCategory.thumbnails.640x360 |String |false |URL to the category image scaled and cropped to 360p 16:9 or empty string.
|highlightedVideos[].topLevelCategory.thumbnails.1920w |String |false |URL to the category image scaled to 1920px wide or empty string.
|highlightedVideos[].topLevelCategory.thumbnails.1280w |String |false |URL to the category image scaled to 1280px wide or empty string.
|highlightedVideos[].topLevelCategory.thumbnails.640w |String |false |URL to the category image scaled to 640px wide or empty string.
|highlightedVideos[].topLevelCategory.thumbnails.320w |String |false |URL to the category image scaled to 320px wide or empty string.
|highlightedVideos[].topLevelCategory.premium |Boolean |false |Indicates whether the category is premium or not.
|highlightedVideos[].topLevelCategory.circle_icon |String |false |URL to the category circle image source or empty string.
|highlightedVideos[].topLevelCategory.color |String | false| Category hex color value.
|highlightedVideos[].topLevelCategory.background |String | false| Url to the category background image.
|===
