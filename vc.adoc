...
|billboard |Array[Object] |false |Array of background (billboard) objects. May be empty.
|billboard[].image |String |false |Image URL.
|billboard[].link |String |false |Link URL. May be empty.
|===
