...
|items[].videos.items[].premium |Boolean |false |Whether the video belongs to Premium category.
...
|videos.items[].premium |Boolean |false |Whether the video belongs to Premium category.
...
|items[].premium |Boolean |false |Whether the video belongs to Premium category.
...
|videoBrief.premium |Boolean |false |Whether the video belongs to Premium category.
...
| collections[].videos.items[].premium |Boolean |false |Whether the video belongs to Premium category.
...
highlighted videos, new releases, playlists, channels
...
|===
| Path | Type | Optional | Description
| highlightedVideos |Object |false |Highlighted videos listing.
| highlightedVideos.items |Array[Object] |false |A list of highlighted videos.
| highlightedVideos.items[].image |String |false |Image URL.
| highlightedVideos.items[].imageWithButton |String |true |URL of image with button.
| highlightedVideos.items[].mobileImage |String |true |URL of mobile optimized image.
| highlightedVideos.items[].video |Object |false |Highlighted video object.
| highlightedVideos.items[].video.id |String |false |Unique ID of the Video.
| highlightedVideos.items[].video.name |String |false |Name of the Video (e.g. 'RPM #79 Express', 'BODYPUMP #100').
| highlightedVideos.items[].video.duration |Integer |false |Video duration in seconds.
| highlightedVideos.items[].video.thumbnail |String |false |Thumbnail of the Video.
| highlightedVideos.items[].video.customInfo |Map |false |Array of Key-Value pairs to represent additional information of an entity.
| highlightedVideos.items[].video.attachments |Array[Object] |true |Video attachments.
| highlightedVideos.items[].video.attachments[].title |string |false |Title of the attachment.
| highlightedVideos.items[].video.attachments[].url |string |false |URL of the attachment.
| highlightedVideos.items[].video.premium |Boolean |false |Whether the video belongs to Premium category.
| highlightedVideos.items[].video.instructor |String |true |Instructor name.
| highlightedVideos.items[].video.level |String |true |Workout level.
| highlightedVideos.items[].video.location |String |true |Location metadata of the video (e.g. 'Wichita', 'Houston').
| highlightedVideos.items[].video.program |Integer |false |Video Category ID.
| highlightedVideos.items[].video.programName |String |false |Video Category name.
| highlightedVideos.items[].video.releaseDate |Integer |false |Video release timestamp.
| highlightedVideos.items[].video.language |String |false |Video language.
...

{
    "highlightedVideos": {
      "items": [
        {
          "image": "https://y360cms.docksal/sites/default/files/2020-03/kids-activities-opt.jpg",
          "imageWithButton": "https://y360cms.docksal/sites/default/files/2020-03/kids-activities-opt.jpg",
          "mobileImage": "https://y360cms.docksal/sites/default/files/2020-03/kids-activities-opt.jpg",
          "video": {
            "id": "87",
            "name": "KIDS YOGA WITH CORRI",
            "thumbnail": "http://embed.wistia.com/deliveries/ea499a80e749b13eb3affe6ff3738596.bin",
...
|national[].videos.items[].premium |Boolean |false |Whether the video belongs to Premium category.
...
|sections[].image |String |false |Image URL.
|sections[].imageWithButton |String |true |URL of image with button.
|sections[].mobileImage |String |true |URL of mobile optimized image.
    ...
    "sections": [
        {
            ...
            "image": "http://y360cms.docksal.site/sites/default/files/2020-01/477A9289%20%281%29.jpg",
            "imageWithButton": "",
            "mobileImage": ""
        },
        {
            ...
            "description": "Slide description text",
            "image": "http://y360cms.docksal.site/sites/default/files/2020-01/477A9289%20%281%29.jpg",
            "imageWithButton": "http://y360cms.docksal.site/sites/default/files/2020-01/477a0890_1.jpg",
            "mobileImage": "http://y360cms.docksal.site/sites/default/files/2023-01/Kelley-min.jpg"
        }
    ],
    "promoLink": {
       "title": "Learn more",
