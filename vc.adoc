...
Must be one of [createdAsc, createdDesc, titleAsc, titleDesc, instructor, location].

createdDesc if not specified.
|===
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v2.0/content-providers/lmod/programs/44440/videos?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760&page=0&limit=50' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
...
createdDesc if not specified.
|vids |String |true |Video IDs joined by comma
|program |String |true |Category filter. Category names joined by comma
|location |String |true |Location filter. Location names joined by comma
|level |String |true |Workout level filter. Level names joined by comma
|instructor |String |true |Instructor filter. Instructor names joined by comma
|equipment |String |true |Equipment filter. Equipment names joined by comma
|===
...
[source,highlightjs,highlight]
----
$ curl 'http://localhost:8080/api/virtual-classes/v2.0/content-providers/lmod/videos?exerciserUuid=8965a460-a79e-4bf7-b66c-7e34d8c34760&searchString=RPM%20%2379%20Express&duration=15m,1hplus&page=0&limit=50' -i -X GET \
    -H 'Accept: application/json' -H 'authorization: apiKey 0a47c3bf-4740-465d-a22e-0b25ef86ddd0'
----
