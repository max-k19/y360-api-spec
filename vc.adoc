...
| recentVideos | Object | false | Recent videos listing.
| recentVideos.items |Array[Object] |false |A page of the recent videos listing.
| recentVideos.items[].id |String |false |Unique ID of the Video.
| recentVideos.items[].name |String |false |Name of the Video (e.g. 'RPM #79 Express', 'BODYPUMP #100').
| recentVideos.items[].duration |Integer |false |Video duration in seconds.
| recentVideos.items[].thumbnail |String |false |Thumbnail of the Video.
| recentVideos.items[].program |Integer |false |Video Category ID.
| recentVideos.items[].programName |String |false |Video Category name.
| recentVideos.items[].releaseDate |Integer |false |Video release timestamp.
| recentVideos.items[].customInfo |Map |false |Array of Key-Value pairs to represent additional information of an entity.
| recentVideos.items[].attachments |Array[Object] |true |Video attachments.
| recentVideos.items[].attachments[].title |string |false |Title of the attachment.
| recentVideos.items[].attachments[].url |string |false |URL of the attachment.
| recentVideos.summary |Object |false |Page summary.
| recentVideos.summary.limit |Integer |false |Requested size of the page.
| recentVideos.summary.page |Integer |false |Page number.
| recentVideos.summary.total |Integer |false |Total count of items.
