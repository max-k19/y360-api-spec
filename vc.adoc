...
|settings[].value |Object |false |Setting's value.
|settings[].value.type |String |false |Setting's value type (e.g. 'text', 'image', 'video').
|settings[].value.data |String/Array[Object] |false |Setting's value (text value, image URL, list of video data).
|settings[].value.data.method |String |true |Format of the video (e.g. 'hls', 'dash', 'progressive').
|settings[].value.data.codec |String |true |Codec of the video (e.g. 'h264').
|settings[].value.data.mimeType |String |true |Mime-type of the video (e.g. 'application/x-mpegURL', 'application/dash+xml', 'video/mp4').
|settings[].value.data.format |String |true |Format of the video (e.g. 'm3u8', 'mpd', 'mp4', 'webm', 'ogg').
|settings[].value.data.quality |String |true |Quality of the video (e.g. '080p', '720p', '540p', '480p', '360p', 'adaptive').
|settings[].value.data.sizeInBytes |Integer |true |Size of the video.
|settings[].value.data.sourceUrl |String |false |Url of the video file.
|===
...
This operation returns setting by key.
...
|===
|Path |Type |Optional |Description
|value |Object |false |Setting's value.
|value.type |String |false |Setting's value type (e.g. 'text', 'image', 'video').
|value.data |String/Array[Object] |false |Setting's value (text value, image URL, list of video data).
|value.data.method |String |true |Format of the video (e.g. 'hls', 'dash', 'progressive').
|value.data.codec |String |true |Codec of the video (e.g. 'h264').
|value.data.mimeType |String |true |Mime-type of the video (e.g. 'application/x-mpegURL', 'application/dash+xml', 'video/mp4').
|value.data.format |String |true |Format of the video (e.g. 'm3u8', 'mpd', 'mp4', 'webm', 'ogg').
|value.data.quality |String |true |Quality of the video (e.g. '080p', '720p', '540p', '480p', '360p', 'adaptive').
|value.data.sizeInBytes |Integer |true |Size of the video.
|value.data.sourceUrl |String |false |Url of the video file.
|===
...
[[footer]]
[[footer-text]]
Last updated 2020-01-08 15:01:00 +0200
